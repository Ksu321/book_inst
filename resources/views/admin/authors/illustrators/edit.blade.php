...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            {{Form::open([
                            'route'	=>	['illustrators.update', $illustrator->id],
                            'files'	=>	true,
                            'method'	=>	'put'
	                ])}}
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Ім’я та прізвище письменника або псведонім" value="{{$illustrator->name}}">
                        </div>

                        <div class="form-group">
                            <img src="{{$illustrator->getImage()}}" alt="" class="img-responsive" width="200">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" style="width: 100%;">
                                ...
                                <input type="text" name="phone" value="{{$illustrator->phone}}" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask placeholder="(___) ___-____">
                            </div>
                            <div class="input-group" style="width: 100%;">
                                <span class="input-group-addon" style="width: 50px;"><i class="fa fa-envelope"></i></span>
                                <input type="email" name="email" class="form-control" placeholder="Email" value="{{$illustrator->email}}">
                            </div>
                            <div class="input-group" style="width: 100%;">
                        ...
                        <div class="form-group">
                            <label>
                                {{Form::checkbox('status', '1', $illustrator->status, ['class'=>'minimal'])}}
                            </label>
                            <label>
                                Чернетка
                            </label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="biography" id="" cols="30" rows="10" class="form-control" style="resize: none" placeholder="Опис біографії та навичок ілюстратора">{{$illustrator->biography}}</textarea>
